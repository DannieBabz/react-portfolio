    ...
    return ( 
        <>
            <div className="flex flex-col justify-between mt-20 md:mt-60 md:flex-row text-primary">
                <div className="w-30 leading-10 md:w-[40%]" data-aos="fade-right"
     data-aos-offset="500"
     data-aos-easing="ease-in-sine">
                    ...
                    <p className="leading-6 w-fit mr-auto justify-center text-justify text-[16px] md:text-[18px] md:pb-10 lg:w-[50rem] md:text-justify">I&apos;m passionate about creating beautiful and functional web solutions that leave a lasting impact. With a blend of creativity and technical expertise, I bring ideas to life in the digital world.</p>
                    
                </div>
                <div className="m-auto" data-aos="zoom-in">
                    <img src="/20231213_151059-removebg.png" alt="Me" className="w-96 h-96 md:w-[30rem] md:h-[30rem
