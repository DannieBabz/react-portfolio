            ...
            <div className="flex flex-col space-y-10 pb-20 pl-2 pt-80 lg:justify-center lg:flex-row lg:space-x-24 lg:pt-52 lg:pb-40">
                ...
                <div className="flex flex-col space-y-10">
                    <div className="flex flex-col w[18rem] space-y-5 lg:space-x-24 lg:flex-row" >
                        ...
                        <img src="/todoimg.png" alt="Todolist" className="w-[18rem] h-[10rem] m-auto md:w-[40rem] md:h-[20rem] hover:scale-125 transition-all" data-aos="fade-right" data-aos-duration="700"/></a>
                    ...
                    <div className="flex flex-col-reverse w[18rem] space-y-5 lg:space-x-24 lg:flex-row">
                        ...
                        <img src="/sol.png" alt="Solana Homepage" className="w-[18rem] h-[10rem] m-auto md:w-[40rem] md:h-[20rem] hover:scale-125 transition-all" data-aos="zoom-in-down" data-aos-duration="700"/></a>
                    </div>
                    <div className="flex flex-col w[18rem] space-y-5 lg:space-x-24 lg:flex-row">
                        <a href="https://crappo-cryptocurrency-web.netlify.app/">
                        <img src="/crappo.png" alt="Crappo" className="w-[18rem] h-[10rem] m-auto md:w-[40rem] md:h-[20rem] hover:scale-125 transition-all"  data-aos="zoom-in-right" data-aos-duration="700"/></a>
                    ...
                    <div className="flex flex-col-reverse w[18rem] space-y-5 lg:space-x-24 lg:flex-row">
                        ...
                        <img src="/bin2dec.png" alt="Binary to Decimal" className="w-[18rem] h-[10rem] m-auto md:w-[40rem] md:h-[20rem] hover:scale-125 transition-all" data-aos="zoom-out-down" data-aos-duration="700"/></a>
                    </div>
                    <div className="flex flex-col w[18rem] space-y-5 lg:space-x-24 lg:flex-row">
                        <a href="https://jscountdown-timer.netlify.app/">
                        <img src="/countdown.png" alt="Countdown Timer" className="w-[18rem] h-[10rem] m-auto md:w-[40rem] md:h-[20rem] hover:scale-125 transition-all" data-aos="zoom-in-down" data-aos-duration="700"/></a>
